...
| Full lint/typecheck, API/app tests, contracts, build, backlog and review gate | Guarded group21400 exit0; 648 app, 14 operations and 57 review-gate tests; peak2955120KiB; remaining[] | PASS |
...
| Two-client refresh, complete roster, picker draft/caret, transfer focus and scoring recovery | match-refresh.spec.ts: 14 browser tests PASS, group27686 exit0; peak1219888KiB; remaining[] | PASS |
